...
int usb_lowlevel_init(void)
{
	 ...
	 */
#ifdef CONFIG_S3C2460
	CLKSRC_REG |= SelUPLL;	/* for 2460 */
	CLKDIV_REG |= (1<<12);	/* for 2460 */
	UPLLCON_REG = 0x00480301;
#endif
	...
	gohci.sleeping = 0;
	gohci.irq = -1;
	gohci.regs = (struct ohci_regs *)ELFIN_USB_HOST_BASE;

	gohci.flags = 0;
	gohci.slot_name = "s3c2460";
